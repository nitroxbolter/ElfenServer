local mType = Game.createMonsterType("Gor'gul The Frienzied")
local monster = {}

monster.description = "Gor'gul The Frienzied"
...
monster.health = 1050000
monster.maxHealth = 1050000
monster.race = "undead"
...
monster.loot = {
	...
	{id = "bride wings", chance = 500},
	{id = "Scarlet Raven", chance = 400},
...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = -1500, maxDamage = -4200},
	{name ="combat", interval = 1000, chance = 10, type = COMBAT_PHYSICALDAMAGE, minDamage = -1650, maxDamage = -5100, length = 10, spread = 3, effect = 307, target = false},
	{name ="combat", interval = 1000, chance = 8, type = COMBAT_DEATHDAMAGE, minDamage = -1630, maxDamage = -3660, radius = 5, shootEffect = 69, effect = 302, target = false},
	{name ="combat", interval = 2000, chance = 9, type = COMBAT_EARTHDAMAGE, minDamage = -1700, maxDamage = -2885, length = 8, spread = 3, effect = 304, target = false},
	{name ="combat", interval = 1000, chance = 8, type = COMBAT_ICEDAMAGE, minDamage = -1400, maxDamage = -2930, radius = 6, effect = 282, target = false},
	{name ="drunk", interval = 3000, chance = 11, radius = 6, effect = 289, target = false},
	{name ="condition", type = CONDITION_FREEZING, interval = 2000, chance = 15, minDamage = -1250, maxDamage = -1950, radius = 4, effect = 284, target = false}
}
