local mType = Game.createMonsterType("Aquatic Overlord Thalassa")
local monster = {}

monster.description = "Aquatic Overlord Thalassa"
...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 30, type = COMBAT_FIREDAMAGE, minDamage = -1950, maxDamage = -5400, range = 7, radius = 3, shootEffect = 71, effect = 277, target = true},
	{name ="combat", interval = 2000, chance = 10, type = COMBAT_ICEDAMAGE, minDamage = -2200, maxDamage = -6500, length = 8, spread = 3, effect = 300, target = false},
	{name ="combat", interval = 2000, chance = 10, type = COMBAT_ICEDAMAGE, minDamage = -2300, maxDamage = -7200, length = 10, spread = 0, effect = 301, target = false},
	{name ="combat", interval = 2000, chance = 30, type = COMBAT_ENERGYDAMAGE, minDamage = -1400, maxDamage = -5500, range = 7, radius = 4, shootEffect = 82, effect = 256, target = true},
}
