local mType = Game.createMonsterType("Tymagron The Earthshaker")
local monster = {}

monster.description = "Tymagron The Earthshaker"
...
monster.loot = {
	...
	{id = "strenght wings", chance = 500},
	{id = "The Counterspell", chance = 400},
...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 15, type = COMBAT_ICEDAMAGE, minDamage = -1200, maxDamage = -2400, range = 3, length = 6, spread = 8, effect = 232, target = false},
	{name ="combat", interval = 2000, chance = 20, type = COMBAT_ICEDAMAGE, minDamage = -1950, maxDamage = -3000, range = 3, length = 9, spread = 4, effect = 228, target = false},
	{name ="combat", interval = 2000, chance = 15, type = COMBAT_PHYSICALDAMAGE, minDamage = -1650, maxDamage = -4000, radius = 2, effect = 206, target = false},
	{name ="combat", interval = 2000, chance = 15, type = COMBAT_PHYSICALDAMAGE, minDamage = -1700, maxDamage = -6900, radius = 8, effect = 207, target = false},
	{name ="combat", interval = 2000, chance = 20, type = COMBAT_ICEDAMAGE, minDamage = -2500, maxDamage = -6600, radius = 3, effect = 202, target = false},
	{name ="combat", interval = 2000, chance = 15, type = COMBAT_ENERGYDAMAGE, minDamage = -1800, maxDamage = -5000, radius = 5, effect = 205, target = false}
}
