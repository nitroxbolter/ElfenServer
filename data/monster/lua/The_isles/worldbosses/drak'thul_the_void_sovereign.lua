local mType = Game.createMonsterType("Drak'thul The Void Sovereign")
local monster = {}

monster.description = "Drak'thul The Void Sovereign"
monster.experience = 395000
monster.outfit = {
	lookType = 1134,
	lookHead = 0,
	lookBody = 0,
...
monster.loot = {
	...
	{id = "nimbus wings", chance = 500},
	{id = "Shadowmeld", chance = 400},
...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, skill = 380, attack = 380},
	{name ="combat", interval = 3000, chance = 20, type = COMBAT_EARTHDAMAGE, minDamage = -1900, maxDamage = -4800, length = 10, spread = 3, effect = 249, target = false},
	{name ="combat", interval = 2000, chance = 20, type = COMBAT_EARTHDAMAGE, minDamage = -1500, maxDamage = -4300, radius = 7, effect = 242, target = false},
	{name ="combat", interval = 2000, chance = 15, type = COMBAT_EARTHDAMAGE, minDamage = -1900, maxDamage = -5700, radius = 5, effect = 236, target = false},
	{name ="combat", interval = 2000, chance = 20, type = COMBAT_EARTHDAMAGE, minDamage = -2100, maxDamage = -8000, length = 12, spread = 3, effect = 235, target = false},
	{name ="combat", interval = 2000, chance = 20, type = COMBAT_EARTHDAMAGE, minDamage = -1800, maxDamage = -3100, length = 10, spread = 3, effect = 233, target = false},
	{name ="combat", interval = 2000, chance = 20, type = COMBAT_EARTHDAMAGE, minDamage = -1000, maxDamage = -2300, length = 10, spread = 3, effect = 199, target = false}
}
