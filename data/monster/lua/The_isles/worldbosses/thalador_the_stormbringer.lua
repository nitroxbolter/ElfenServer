local mType = Game.createMonsterType("Thalador The Stormbringer")
local monster = {}

monster.description = "Thalador The Stormbringer"
...
monster.loot = {
	...
	{id = "enslaved wings", chance = 500},
	{id = "Menethil March", chance = 400},
...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, skill = 350, attack = 350},
	{name ="thaladorenergy", interval = 2000, chance = 15, minDamage = -1600, maxDamage = -5000, target = false},
	{name ="combat", interval = 2000, chance = 15, type = COMBAT_ENERGYDAMAGE, minDamage = -1500, maxDamage = -6000, length = 10, spread = 3, effect = 245, target = false},
	{name ="combat", interval = 2000, chance = 16, type = COMBAT_ENERGYDAMAGE, minDamage = -2550, maxDamage = -7300, range = 7, radius = 3, shootEffect = 5, effect = 241, target = true},
	{name ="combat", interval = 2000, chance = 19, type = COMBAT_ENERGYDAMAGE, minDamage = -2500, maxDamage = -5500, radius = 4, effect = 250, target = false},
	{name ="energyfield", interval = 2000, chance = 12, radius = 6, shootEffect = 70, effect = 209, target = true},
	{name ="combat", interval = 2000, chance = 4, type = COMBAT_ENERGYDAMAGE, minDamage = -2900, maxDamage = -6600, range = 3, shootEffect = 70, effect = 240, target = false}
}
