local mType = Game.createMonsterType("Azazel The Infernal Seraph")
local monster = {}

monster.description = "Azazel The Infernal Seraph"
...
monster.attacks = {
	...
	{name ="combat", interval = 3000, chance = 25, type = COMBAT_HOLYDAMAGE, minDamage = -500, maxDamage = -2900, length = 10, spread = 3, effect = 269, target = false},
	{name ="combat", interval = 2000, chance = 15, type = COMBAT_HOLYDAMAGE, minDamage = -900, maxDamage = -4700, radius = 5, effect = 263, target = false},
	{name ="combat", interval = 2000, chance = 15, type = COMBAT_HOLYDAMAGE, minDamage = -1100, maxDamage = -3000, length = 10, spread = 3, effect = 259, target = false},
	{name ="combat", interval = 2000, chance = 15, type = COMBAT_FIREDAMAGE, minDamage = -1200, maxDamage = -5800, length = 8, spread = 3, effect = 261, target = false},
	{name ="azazelsanctum", interval = 2000, chance = 18, minDamage = -2000, maxDamage = -3500, target = true},
}
