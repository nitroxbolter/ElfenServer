...
function creatureSayCallback(cid, type, msg)
	...
	elseif(msgcontains(msg, "yes")) then
		if(npcHandler.topic[cid] == 1) then
			...
			PlayerSetStorageValue(cid, 20051, 1) -- quest log mission 1 completada
			PlayerSetStorageValue(cid, 20052, 0) -- quest log mission 2
			PlayerSetStorageValue(cid, 871241, 1) -- quest log mission 2
		end
	end
