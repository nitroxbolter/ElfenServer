...
keywordHandler:addKeyword({'illusionist'}, StdModule.say, {npcHandler = npcHandler, text = 'I wanted to become an illusionist, too, but I was overqualified!'}, function(player) return player:isIllusionist() end)
