...
local voices = { {text = 'Passages to Vyrsk, expedition isle, Carlin, Ab\'Dendriel, Edron, Venore, Port Hope, Liberty Bay, Yalahar, Roshamuul, Krailos, Oramond, Svargrond and Bounac.'} }
...
addTravelKeyword('bounac', 320, Position(33641, 31469, 6))
addTravelKeyword('kilmaresh', 580, Position(33714, 31188, 6))
addTravelKeyword('vyrsk', 800, Position(31190, 31317, 6))
...
keywordHandler:addKeyword({'trip'}, StdModule.say, {npcHandler = npcHandler, text = 'Where do you want to go? To {Carlin}, {Ab\'Dendriel}, {Venore}, {Port Hope}, {Liberty Bay}, {Svargrond}, {Yalahar}, {Roshamuul}, {krailos}, {Oramond}, {Edron}, {Bounac}, {Kilmaresh} or {Vyrsk}?'})
keywordHandler:addKeyword({'route'}, StdModule.say, {npcHandler = npcHandler, text = 'Where do you want to go? To {Carlin}, {Ab\'Dendriel}, {Venore}, {Port Hope}, {Liberty Bay}, {Svargrond}, {Yalahar}, {Roshamuul}, {krailos}, {Oramond}, {Edron}, {Bounac}, {Kilmaresh} or {Vyrsk}?'})
keywordHandler:addKeyword({'passage'}, StdModule.say, {npcHandler = npcHandler, text = 'Where do you want to go? To {Carlin}, {Ab\'Dendriel}, {Venore}, {Port Hope}, {Liberty Bay}, {Svargrond}, {Yalahar}, {Roshamuul}, {krailos}, {Oramond}, {Edron}, {Bounac}, {Kilmaresh} or {Vyrsk}?'})
keywordHandler:addKeyword({'town'}, StdModule.say, {npcHandler = npcHandler, text = 'Where do you want to go? To {Carlin}, {Ab\'Dendriel}, {Venore}, {Port Hope}, {Liberty Bay}, {Svargrond}, {Yalahar}, {Roshamuul}, {krailos}, {Oramond}, {Edron}, {Bounac}, {Kilmaresh} or {Vyrsk}?'})
keywordHandler:addKeyword({'destination'}, StdModule.say, {npcHandler = npcHandler, text = 'Where do you want to go? To {Carlin}, {Ab\'Dendriel}, {Venore}, {Port Hope}, {Liberty Bay}, {Svargrond}, {Yalahar}, {Roshamuul}, {krailos}, {Oramond}, {Edron}, {Bounac}, {Kilmaresh} or {Vyrsk}?'})
keywordHandler:addKeyword({'sail'}, StdModule.say, {npcHandler = npcHandler, text = 'Where do you want to go? To {Carlin}, {Ab\'Dendriel}, {Venore}, {Port Hope}, {Liberty Bay}, {Svargrond}, {Yalahar}, {Roshamuul}, {krailos}, {Oramond}, {Edron}, {Bounac}, {Kilmaresh} or {Vyrsk}?'})
keywordHandler:addKeyword({'go'}, StdModule.say, {npcHandler = npcHandler, text = 'Where do you want to go? To {Carlin}, {Ab\'Dendriel}, {Venore}, {Port Hope}, {Liberty Bay}, {Svargrond}, {Yalahar}, {Roshamuul}, {krailos}, {Oramond}, {Edron}, {Bounac}, {Kilmaresh} or {Vyrsk}?'})
...
npcHandler:setMessage(MESSAGE_GREET, 'Welcome on board, |PLAYERNAME|. Where can I {sail} you today? To {Carlin}, {Ab\'Dendriel}, {Venore}, {Port Hope}, {Liberty Bay}, {Svargrond}, {Yalahar}, {Roshamuul}, {krailos}, {Oramond}, {Edron}, {Bounac}, {Kilmaresh} or {Vyrsk} to make some expeditions?')
