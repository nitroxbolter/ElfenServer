...
local function addTravelKeyword(keyword, cost, destination)
	local travelKeyword = keywordHandler:addKeyword({keyword}, StdModule.say, {npcHandler = npcHandler, text = 'Do you want to sail to ' .. keyword:titleCase() .. ' for ' .. cost ..'?', cost = cost, discount = 'postman'})
