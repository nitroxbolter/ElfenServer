...
addTravelKeyword('farmine', 'Farmine', 110, Position(32983, 31539, 1))
addTravelKeyword('darashia', 'Darashia on Darama', 140, Position(33270, 32441, 6))
addTravelKeyword('kazordoon', 'Kazordoon', 200, Position(32588, 31942, 0))
addTravelKeyword('femor hills', 'the Femor Hills', 170, Position(32536, 31837, 4))
addTravelKeyword('svargrond', 'Svargrond', 260, Position(32253, 31097, 4))
addTravelKeyword('edron', 'Edron', 175, Position(33193, 31784, 3))
