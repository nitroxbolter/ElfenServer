...
function creatureSayCallback(cid, type, msg)
	...
	elseif(msgcontains(msg, "strange")) then
		if(npcHandler.topic[cid] == 2) then
			...
			PlayerSetStorageValue(cid, 10050, 1)
			PlayerSetStorageValue(cid, 20050, 1) -- quest log mission 1
			PlayerSetStorageValue(cid, 20051, 0) -- quest log mission 1
		...
		if(getPlayerStorageValue(cid, 10050) == 18) then
			...
			PlayerSetStorageValue(cid, 10050, 19)
