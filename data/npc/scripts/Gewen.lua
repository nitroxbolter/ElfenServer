...
addTravelKeyword('darashia', 'Darashia on Darama', 200, Position(33270, 32441, 6))
addTravelKeyword('svargrond', 'Svargrond', 260, Position(32253, 31097, 4))
addTravelKeyword('femor hills', 'the Femor Hills', 185, Position(32536, 31837, 4))
addTravelKeyword('edron', 'Edron', 190, Position(33193, 31784, 3))
