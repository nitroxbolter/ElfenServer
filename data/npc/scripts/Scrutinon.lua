...
addTravelKeyword('ab\'dendriel', 250, Position(32734, 31668, 6))
addTravelKeyword('edron', 250, Position(33175, 31764, 6))
addTravelKeyword('venore', 250, Position(32954, 32022, 6))
addTravelKeyword('darashia', 250, Position(33289, 32480, 6))




keywordHandler:addKeyword({'name'}, StdModule.say, {npcHandler = npcHandler, text = "My name is Scrutinon. However, there are not many people calling my name nowadays. Not many captains even dare to land on this island. It is too close to {Quirefang}. ...",
...
keywordHandler:addKeyword({'quirefang'}, StdModule.say, {npcHandler = npcHandler, text = "This island is cleft. Go there only prepared or you will meet your end. The surface of this forgotten rock is a barren wasteland full of hostile creatures. ...",
