...
local function addTravelKeyword(keyword, text, destination)
	local travelKeyword = keywordHandler:addKeyword({keyword}, StdModule.say, {npcHandler = npcHandler, text = 'Give me 100 Gold Coins and I bring you to ' .. text, cost = 100, discount = 'postman'})
