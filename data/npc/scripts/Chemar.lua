...
local function addTravelKeyword(keyword, cost, destination)
	...
	local travelKeyword = keywordHandler:addKeyword({keyword}, StdModule.say, {npcHandler = npcHandler, text = 'Do you seek a ride to ' .. keyword:titleCase() .. ' for ' .. cost .. ' ?', cost = cost, discount = 'postman'})
...
addTravelKeyword('farmine', 170, Position(32983, 31539, 1))
addTravelKeyword('edron', 140, Position(33193, 31784, 3))
addTravelKeyword('svargrond', 160, Position(32253, 31097, 4))
addTravelKeyword('femor hills', 180, Position(32536, 31837, 4))
addTravelKeyword('kazordoon', 220, Position(32588, 31942, 0))
