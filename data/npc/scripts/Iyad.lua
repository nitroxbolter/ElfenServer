...
addTravelKeyword('farmine', 'Farmine', 180, Position(32983, 31539, 1))
addTravelKeyword('darashia', 'Darashia on Darama', 145, Position(33270, 32441, 6))
addTravelKeyword('kazordoon', 'Kazordoon', 200, Position(32588, 31942, 0))
addTravelKeyword('femor hills', 'the Femor Hills', 190, Position(32536, 31837, 4))
addTravelKeyword('edron', 'Edron', 210, Position(33193, 31784, 3))
