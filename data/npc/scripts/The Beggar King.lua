...
function creatureSayCallback(cid, type, msg)
	...
	elseif(msgcontains(msg, "abandoned sewers")) then
		if(npcHandler.topic[cid] == 4) then
			...
			PlayerSetStorageValue(cid, 20052, 1) -- quest log mission 2 completada
			PlayerSetStorageValue(cid, 20053, 0) -- quest log mission 2
			PlayerSetStorageValue(cid, 10050, 3) -- quest log mission 3
