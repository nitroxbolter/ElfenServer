...
function creatureSayCallback(cid, type, msg)
	...
	if(msgcontains(msg, "ritual")) then
		if(getPlayerStorageValue(cid, 10050) == 6) then
           ...
           PlayerSetStorageValue(cid, 10050, 7)
		   PlayerSetStorageValue(cid, 20056, 1)
		   PlayerSetStorageValue(cid, 20057, 0)
		end
	elseif(msgcontains(msg, "abandoned sewers")) then
		if(getPlayerStorageValue(cid, 10050) == 7) then
			...
			PlayerSetStorageValue(cid, 10050, 9)
		   PlayerSetStorageValue(cid, 20058, 1)
		   PlayerSetStorageValue(cid, 20059, 0)
		end
	...
	elseif(msgcontains(msg, "notebook")) then
		if(getPlayerStorageValue(cid, 10050) == 9) then
			...
			PlayerSetStorageValue(cid, 10050, 13)
		   PlayerSetStorageValue(cid, 30050, 1)
		   PlayerSetStorageValue(cid, 30051, 0)
		end	
else
