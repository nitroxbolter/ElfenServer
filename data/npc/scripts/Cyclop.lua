...
local items = {
          item5 = {2487, 5887}, -- item1 item que ser� pedido e que ser� dado na primeira troca
          item4 = {2516, 5889}, -- item2 item que ser� pedido e que ser� dado na segunda troca
		  item3 = {2462, 5888}, -- item3 item que ser� pedido e que ser� dado na segunda troca
		  item2 = {2393, 5892}, -- item3 item que ser� pedido e que ser� dado na segunda troca
		  
		  item1 = {5944, 6529} -- item3 item que ser� pedido e que ser� dado na segunda troca
		 
}
local counts = {
          count5 = {1, 1}, -- count1 quantidade que ser� pedido e que ser� dado na primeira troca
          count4 = {1, 1}, -- count2 quantidade que ser� pedido e que ser� dado na segunda troca
		  count3 = {1, 1}, -- count3 quantidade que ser� pedido e que ser� dado na segunda troca
		  count2 = {1, 1}, -- count4 quantidade que ser� pedido e que ser� dado na segunda troca
		  
		  count1 = {1, 3} -- count4 quantidade que ser� pedido e que ser� dado na segunda troca
...
function creatureSayCallback(cid, type, msg)
          ...
          if msgcontains(msg, 'soul orb') or msgcontains(msg, 'infernal bolt') then
                    if getPlayerItemCount(cid, items.item1[1]) >= counts.count1[1] then
                              PlayerRemoveItem(cid, items.item1[1], counts.count1[1])
