...
function creatureSayCallback(cid, type, msg)
    ...
    elseif msgcontains(msg, 'yes') and Topic[cid] == 2 then
        if PlayerRemoveMoney(cid, count[cid]) then
            PlayerSetBalance(cid, getPlayerBalance(cid) + count[cid])
    ...
    elseif Topic[cid] == 7 and msgcontains(msg, 'yes') then
        if getPlayerBalance(cid) - getPlayerBiddedMoney(cid) >= count[cid] then
            ...
            if v then
                PlayerSetBalance(cid, getPlayerBalance(cid) - count[cid])
                updatePlayerBalance(getPlayerName(cid), getPlayerBalance(cid))
                PlayerSetBalance(v, getPlayerBalance(v) + count[cid])
    ...
    elseif Topic[cid] == 9 then
        if msgcontains(msg, 'yes') then
            if PlayerRemoveItem(cid, 2148, count[cid] * 100) then
    ...
    elseif Topic[cid] == 12 then
        if msgcontains(msg, 'yes') then
            if PlayerRemoveItem(cid, 2152, count[cid]) then
                npcHandler:say('Here you are.', cid)
    ...
    elseif Topic[cid] == 14 then
        if msgcontains(msg, 'yes') then
            if PlayerRemoveItem(cid, 2152, count[cid] * 100) then
                npcHandler:say('Here you are.', cid)
    ...
    elseif Topic[cid] == 16 then
        if msgcontains(msg, 'yes') then
            if PlayerRemoveItem(cid, 2160, count[cid]) then
                npcHandler:say('Here you are.', cid)
