...
function elementalistFirst(cid, message, keywords, parameters, node) 
    ...
    if addon == -1 then 
        ...
        if PlayerRemoveItem(cid,13940,1) then 
            ...
            PlayerSetStorageValue(cid,elementalist,1) 
        end 
        else 
            selfSay(noitems, cid) 
        end 
...
function elementalistSecond(cid, message, keywords, parameters, node) 
    ...
    if addon == -1 then 
        ...
        if PlayerRemoveItem(cid,13756,1) then 
            ...
            PlayerSetStorageValue(cid,elementalist+1,1) 
        end 
        else 
            selfSay(noitems, cid) 
        end 
...
function riftFirst(cid, message, keywords, parameters, node) 
    ...
    if addon == -1 then 
        ...
        if PlayerRemoveItem(cid,25378,3) then 
            ...
            PlayerSetStorageValue(cid,rift,1) 
        end 
        else 
            selfSay(noitems, cid) 
        end 
...
function riftSecond(cid, message, keywords, parameters, node) 
    ...
    if addon == -1 then 
        ...
        if PlayerRemoveItem(cid,25172,200) then 
            ...
            PlayerSetStorageValue(cid,rift+1,1) 
        end 
        else 
            selfSay(noitems, cid) 
        end 
...
function GloothFirst(cid, message, keywords, parameters, node) 
    ...
    if addon == -1 then 
        ...
        if PlayerRemoveItem(cid,21400,10) then 
            ...
            PlayerSetStorageValue(cid,glooth,1) 
        end 
        else 
            selfSay(noitems, cid) 
        end 
...
function GloothSecond(cid, message, keywords, parameters, node) 
    ...
    if addon == -1 then 
        ...
        if PlayerRemoveItem(cid,21400,10) then 
            ...
            PlayerSetStorageValue(cid,glooth+1,1) 
        end 
        else 
            selfSay(noitems, cid) 
        end 
...
function YalaharianFirst(cid, message, keywords, parameters, node) 
    ...
    if addon == -1 then 
        ...
        if PlayerRemoveItem(cid,21400,10) then 
            ...
            PlayerSetStorageValue(cid,yalaharian,1) 
        end 
        else 
            selfSay(noitems, cid) 
        end 
...
function YalaharianSecond(cid, message, keywords, parameters, node) 
    ...
    if addon == -1 then 
        ...
        if PlayerRemoveItem(cid,21400,10) then 
            ...
            PlayerSetStorageValue(cid,yalaharian+1,1) 
        end 
        else 
            selfSay(noitems, cid) 
        end 
...
function PumpkinFirst(cid, message, keywords, parameters, node) 
    ...
    if addon == -1 then 
        ...
        if PlayerRemoveItem(cid,21400,20) then 
            ...
            PlayerSetStorageValue(cid,pumpkin,1) 
        end 
        else 
            selfSay(noitems, cid) 
        end 
...
function PumpkinSecond(cid, message, keywords, parameters, node) 
    ...
    if addon == -1 then 
        ...
        if PlayerRemoveItem(cid,21400,20) then 
            ...
            PlayerSetStorageValue(cid,pumpkin+1,1) 
        end 
        else 
            selfSay(noitems, cid) 
        end 
...
function CitizenFirst(cid, message, keywords, parameters, node) 
    ...
    if addon == -1 then 
        ...
        if PlayerRemoveItem(cid,5878,100) then 
            ...
            PlayerSetStorageValue(cid,citizen,1) 
        end 
        else 
            selfSay(noitems, cid) 
        end 
...
function CitizenSecond(cid, message, keywords, parameters, node) 
    ...
    if addon == -1 then 
        ...
        if PlayerRemoveItem(cid,5890,100) and PlayerRemoveItem(cid,5902,50) and PlayerRemoveItem(cid,2480,1) then 
            ...
            PlayerSetStorageValue(cid,citizen+1,1) 
        end 
        else 
            selfSay(noitems, cid) 
        end 
...
function HunterSecond(cid, message, keywords, parameters, node) 
    ...
    if addon == -1 then 
        ...
        if PlayerRemoveItem(cid,5875,1) then 
            ...
            PlayerSetStorageValue(cid,hunter+1,1) 
        end 
        else 
            selfSay(noitems, cid) 
        end 
...
function MageFirst(cid, message, keywords, parameters, node) 
    ...
    if addon < 2 then 
        if getPlayerSex(cid) == 0 then -- PLAYERSEX == 0 � female
        ...
        if PlayerRemoveItem(cid,5958,1) then 
            ...
            PlayerSetStorageValue(cid,mage,1) 
        end 
        else 
            selfSay(noitems, cid) 
        end 
        elseif getPlayerSex(cid) == 1 then -- PLAYERSEX == 1 � male
...
function MageSecond(cid, message, keywords, parameters, node) 
    ...
    if addon < 2 then 
        ...
        if PlayerRemoveItem(cid,5894,70) and PlayerRemoveItem(cid,5911,20) and PlayerRemoveItem(cid,5883,40) and PlayerRemoveItem(cid,5922,35) and PlayerRemoveItem(cid,5886,10) and PlayerRemoveItem(cid,5881,60) and PlayerRemoveItem(cid,5882,40) and PlayerRemoveItem(cid,5904,15) and PlayerRemoveItem(cid,5905,30) then 
            ...
            PlayerSetStorageValue(cid,mage+1,1) 
        end 
        else 
            selfSay(noitems, cid) 
        end 
...
function NoblemanFirst(cid, message, keywords, parameters, node) 
    ...
    if addon == -1 then 
        ...
        if PlayerRemoveMoney(cid,150000) then 
            ...
            PlayerSetStorageValue(cid,nobleman,1) 
        end 
        else 
            selfSay(noitems, cid) 
        end 
...
function NoblemanSecond(cid, message, keywords, parameters, node) 
    ...
    if addon == -1 then 
        ...
        if PlayerRemoveMoney(cid,150000) then 
            ...
            PlayerSetStorageValue(cid,nobleman+1,1) 
        end 
        else 
            selfSay(noitems, cid) 
        end 
...
function SummonerFirst(cid, message, keywords, parameters, node) 
    ...
    if addon == -1 then 
        ...
        if PlayerRemoveItem(cid,5958,1) then 
            ...
            PlayerSetStorageValue(cid,summoner,1) 
        end 
        else 
            selfSay(noitems, cid) 
        end 
...
function SummonerSecond(cid, message, keywords, parameters, node) 
    ...
    if addon == -1 then 
        if getPlayerSex(cid) == 1 then -- PLAYERSEX == 1 � male
        if getPlayerItemCount(cid,5894) >= 70 and getPlayerItemCount(cid,5911) >= 20 and getPlayerItemCount(cid,5883) >= 40 and getPlayerItemCount(cid,5922) >= 35 and getPlayerItemCount(cid,5886) >= 10 and getPlayerItemCount(cid,5881) >= 60 and getPlayerItemCount(cid,5882) >= 40 and getPlayerItemCount(cid,5904) >= 15 and getPlayerItemCount(cid,5905) >= 30 then 
        if PlayerRemoveItem(cid,5894,70) and PlayerRemoveItem(cid,5911,20) and PlayerRemoveItem(cid,5883,40) and PlayerRemoveItem(cid,5922,35) and PlayerRemoveItem(cid,5886,10) and PlayerRemoveItem(cid,5881,60) and PlayerRemoveItem(cid,5882,40) and PlayerRemoveItem(cid,5904,15) and PlayerRemoveItem(cid,5905,30) then 
            selfSay(newaddon, cid) 
            ...
            PlayerSetStorageValue(cid,summoner+1,1) 
        end 
        else 
            selfSay(noitems, cid) 
        end 
        elseif getPlayerSex(cid) == 0 then -- PLAYERSEX == 0 � female
        if getPlayerItemCount(cid,5903) >= 1 then 
        if PlayerRemoveItem(cid,5903,1) then 
            selfSay(newaddon, cid) 
...
function WarriorFirst(cid, message, keywords, parameters, node) 
    ...
    if addon == -1 then 
        ...
        if PlayerRemoveItem(cid,5925,100) and PlayerRemoveItem(cid,5899,100) and PlayerRemoveItem(cid,5884,1) and PlayerRemoveItem(cid,5919,1) then 
            ...
            PlayerSetStorageValue(cid,warrior,1) 
        end 
        else 
            selfSay(noitems, cid) 
        end 
...
function WarriorSecond(cid, message, keywords, parameters, node) 
    ...
    if addon == -1 then 
        ...
        if PlayerRemoveItem(cid,5887,1) and PlayerRemoveItem(cid,5880,100) then 
            ...
            PlayerSetStorageValue(cid,warrior+1,1) 
        end 
        else 
            selfSay(noitems, cid) 
        end 
...
function BarbarianFirst(cid, message, keywords, parameters, node) 
    ...
    if addon == -1 then 
        ...
        if PlayerRemoveItem(cid,5884,1) and PlayerRemoveItem(cid,5885,1) and PlayerRemoveItem(cid,5911,50) and PlayerRemoveItem(cid,5910,50) and PlayerRemoveItem(cid,5886,10) then 
            ...
            PlayerSetStorageValue(cid,barbarian,1) 
        end 
        else 
            selfSay(noitems, cid) 
        end 
...
function BarbarianSecond(cid, message, keywords, parameters, node) 
    ...
    if addon == -1 then 
        ...
        if PlayerRemoveItem(cid,5880,100) and PlayerRemoveItem(cid,5892,1) and PlayerRemoveItem(cid,5893,50) and PlayerRemoveItem(cid,5876,50) then 
            ...
            PlayerSetStorageValue(cid,barbarian+1,1) 
        end 
        else 
            selfSay(noitems, cid) 
        end 
...
function DruidFirst(cid, message, keywords, parameters, node) 
    ...
    if addon == -1 then 
        ...
        if PlayerRemoveItem(cid,5897,50) and PlayerRemoveItem(cid,5896,50) then 
            ...
            PlayerSetStorageValue(cid,druid,1) 
        end 
        else 
            selfSay(noitems, cid) 
        end 
...
function DruidSecond(cid, message, keywords, parameters, node) 
    ...
    if addon == -1 then 
        ...
        if PlayerRemoveItem(cid,5937,1) and PlayerRemoveItem(cid,5939,1) and PlayerRemoveItem(cid,5906,100) and PlayerRemoveItem(cid,5942,1) and PlayerRemoveItem(cid,5940,1) then 
            ...
            PlayerSetStorageValue(cid,druid+1,1) 
        end 
        else 
            selfSay(noitems, cid) 
        end 
...
function WizardFirst(cid, message, keywords, parameters, node) 
    ...
    if addon == -1 then 
        ...
        if PlayerRemoveItem(cid,2488,1) and PlayerRemoveItem(cid,2123,1) and PlayerRemoveItem(cid,2492,1) and PlayerRemoveItem(cid,2536,1) then 
            selfSay(newaddon, cid) 
            SendMagicEffect(getCreaturePosition(cid), 13) 
            PlayerAddOutfit(cid, 145, 1) 
            PlayerAddOutfit(cid, 149, 1) 
            PlayerSetStorageValue(cid,wizard,1) 
        end 
        else 
            selfSay(noitems, cid) 
        end 
...
function WizardSecond(cid, message, keywords, parameters, node) 
    ...
    if addon == -1 then 
        ...
        if PlayerRemoveItem(cid,5922,50) and getPlayerStorageValue(cid,wizard) then 
            ...
            PlayerSetStorageValue(cid,wizard+1,1) 
        end 
        else 
...
function OrientalFirst(cid, message, keywords, parameters, node) 
    ...
    if addon == -1 then 
        ...
        if PlayerRemoveItem(cid,5945,1) then 
            ...
            PlayerSetStorageValue(cid,oriental,1) 
        end 
        else 
            selfSay(noitems, cid) 
        end 
...
function OrientalSecond(cid, message, keywords, parameters, node) 
    ...
    if addon == -1 then 
        ...
        if PlayerRemoveItem(cid,5883,100) and PlayerRemoveItem(cid,5895,100) and PlayerRemoveItem(cid,5891,2) and PlayerRemoveItem(cid,5912,100) then 
            ...
            PlayerSetStorageValue(cid,oriental+1,1) 
        end 
        else 
            selfSay(noitems, cid) 
        end 
...
function PirateFirst(cid, message, keywords, parameters, node) 
    ...
    if addon == -1 then 
        ...
        if PlayerRemoveItem(cid,6126,100) and PlayerRemoveItem(cid,6097,100) and PlayerRemoveItem(cid,6098,100) then 
            ...
            PlayerSetStorageValue(cid,pirate,1) 
        end 
        else 
            selfSay(noitems, cid) 
        end 
...
function PirateSecond(cid, message, keywords, parameters, node) 
    ...
    if addon == -1 then 
        ...
        if PlayerRemoveItem(cid,6099,1) and PlayerRemoveItem(cid,6100,1) and PlayerRemoveItem(cid,6101,1) and PlayerRemoveItem(cid,6102,1) then 
            ...
            PlayerSetStorageValue(cid,pirate+1,1) 
        end 
        else 
            selfSay(noitems, cid) 
        end 
...
function AssassinFirst(cid, message, keywords, parameters, node) 
    ...
    if addon == -1 then 
        ...
        if PlayerRemoveItem(cid,5912,50) and PlayerRemoveItem(cid,5910,50) and PlayerRemoveItem(cid,5911,50) and PlayerRemoveItem(cid,5913,50) and PlayerRemoveItem(cid,5914,50) and PlayerRemoveItem(cid,5909,50) and PlayerRemoveItem(cid,5886,10) then 
            ...
            PlayerSetStorageValue(cid,assassin,1) 
        end 
        else 
            selfSay(noitems, cid) 
        end 
...
function AssassinSecond(cid, message, keywords, parameters, node) 
    ...
    if addon == -1 then 
        ...
        if PlayerRemoveItem(cid,5930,1) and PlayerRemoveItem(cid,5804,1) then 
            ...
            PlayerSetStorageValue(cid,assassin+1,1) 
        end 
        else 
            selfSay(noitems, cid) 
        end 
...
function BeggarFirst(cid, message, keywords, parameters, node) 
    ...
    if addon == -1 then 
        ...
        if PlayerRemoveItem(cid,5883,100) and PlayerRemoveMoney(cid,20000) then 
            ...
            PlayerSetStorageValue(cid,beggar,1) 
        end 
        else 
            selfSay(noitems, cid) 
        end 
...
function BeggarSecond(cid, message, keywords, parameters, node) 
    ...
    if addon == -1 then 
        ...
        if PlayerRemoveItem(cid,6107,1) then 
            ...
            PlayerSetStorageValue(cid,beggar+1,1) 
        end 
        else 
            selfSay(noitems, cid) 
        end 
...
function ShamanSecond(cid, message, keywords, parameters, node) 
    ...
    if addon == -1 then 
        ...
        if PlayerRemoveItem(cid,3955,5) and PlayerRemoveItem(cid,5015,1) then 
            ...
            PlayerSetStorageValue(cid,shaman,1) 
        end 
        else 
            selfSay(noitems, cid) 
        end 
...
function ShamanFirst(cid, message, keywords, parameters, node) 
    ...
    if addon == -1 then 
        ...
        if PlayerRemoveItem(cid,3966,5) and PlayerRemoveItem(cid,3967,5) then 
            ...
            PlayerSetStorageValue(cid,shaman+1,1) 
        end 
        else 
            selfSay(noitems, cid) 
        end 
...
function NorsemanFirst(cid, message, keywords, parameters, node) 
    ...
    if addon == -1 then 
        ...
        if PlayerRemoveItem(cid,7290,5) then 
            ...
            PlayerSetStorageValue(cid,norseman,1) 
        end 
        else 
            selfSay(noitems, cid) 
        end 
...
function NorsemanSecond(cid, message, keywords, parameters, node) 
    ...
    if addon == -1 then 
        ...
        if PlayerRemoveItem(cid,7290,10) then 
            ...
            PlayerSetStorageValue(cid,norseman+1,1) 
        end 
        else 
            selfSay(noitems, cid) 
        end 
...
function NightmareFirst(cid, message, keywords, parameters, node) 
    ...
    if addon == -1 then 
        ...
        if PlayerRemoveItem(cid,6500,500) then 
            ...
            PlayerSetStorageValue(cid,nightmare,1) 
        end 
        else 
            selfSay(noitems, cid) 
        end 
...
function NightmareSecond(cid, message, keywords, parameters, node) 
    ...
    if addon == -1 then 
        ...
        if PlayerRemoveItem(cid,6500,1500) then 
            ...
            PlayerSetStorageValue(cid,nightmare+1,1) 
        end 
        else 
            selfSay(noitems, cid) 
        end 
...
function JesterFirst(cid, message, keywords, parameters, node) 
    ...
    if addon == -1 then 
        ...
        if PlayerRemoveItem(cid,5879,1) and PlayerRemoveItem(cid,5878,4) then 
            ...
            PlayerSetStorageValue(cid,jester,1) 
        end 
        else 
            selfSay(noitems, cid) 
        end 
...
function JesterSecond(cid, message, keywords, parameters, node) 
    ...
    if addon == -1 then 
        ...
        if PlayerRemoveItem(cid,5909,5) then 
            ...
            PlayerSetStorageValue(cid,jester+1,1) 
        end 
        else 
            selfSay(noitems, cid) 
        end 
...
function BrotherhoodFirst(cid, message, keywords, parameters, node) 
    ...
    if addon == -1 then 
        ...
        if PlayerRemoveItem(cid,6500,500) then 
            ...
            PlayerSetStorageValue(cid,brotherhood,1) 
        end 
        else 
            selfSay(noitems, cid) 
        end 
...
function BrotherhoodSecond(cid, message, keywords, parameters, node) 
    ...
    if addon == -1 then 
        ...
        if PlayerRemoveItem(cid,6500,1500) then 
            ...
            PlayerSetStorageValue(cid,brotherhood+1,1) 
        end 
        else 
            selfSay(noitems, cid) 
        end 
...
function WayfarerFirst(cid, message, keywords, parameters, node) 
    ...
    if addon == -1 then 
        ...
        if PlayerRemoveItem(cid,12657,1) then 
            ...
            PlayerSetStorageValue(cid,wayfarer,1) 
        end 
        else 
            selfSay(noitems, cid) 
        end 
...
function WayfarerSecond(cid, message, keywords, parameters, node) 
    ...
    if addon == -1 then 
        ...
        if PlayerRemoveItem(cid,12656,1) then 
            ...
            PlayerSetStorageValue(cid,wayfarer+1,1) 
        end 
        else 
            selfSay(noitems, cid) 
        end 
...
keywordHandler:addKeyword({'help'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = "What you do is that you type 'first hunter addon' or 'second hunter addon' where you replace 'hunter' with whatever outfit you'd like to achieve the addons for. Assuming that you already collected all the required pieces, say 'yes' and vo�la - you got yourself an addon!"}) 
