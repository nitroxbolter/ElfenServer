...
local travelNode = keywordHandler:addKeyword({'darashia'}, StdModule.say, {npcHandler = npcHandler, text = 'Do you seek a passage to Darashia for '.. dcost ..'?', cost = 60, discount = 'postman'})
	...
	childTravelNode:addChildKeyword({'yes'}, StdModule.travel, {npcHandler = npcHandler, premium = true, cost = 60, discount = 'postman', destination = function(player) return math.random(0, 1) == 1 and Position(33324, 32173, 6) or Position(33289, 32481, 6) end})
