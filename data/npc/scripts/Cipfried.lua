...
keywordHandler:addKeyword({'destiny'}, StdModule.say, {npcHandler = npcHandler, text = 'Your near destiny will be to choose a {vocation} once you are level 8. Whether you will become a {knight}, {sorcerer}, {paladin}, {illusionist} or {druid} is a big decision!'})
...
keywordHandler:addKeyword({'vocation'}, StdModule.say, {npcHandler = npcHandler, text = 'There are four vocations in Tibia: {knight}, {sorcerer}, {illusionist}, {paladin} or {druid}. Each vocation has its unique special abilities.'})
...
keywordHandler:addKeyword({'illusionist'}, StdModule.say, {npcHandler = npcHandler, text = 'Illusionists are powerful illusioners mages. They have mastered water, fire, energy and death magic.'})
