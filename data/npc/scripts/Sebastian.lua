...
local function addTravelKeyword(keyword, cost, destination)
	local travelKeyword = keywordHandler:addKeyword({keyword}, StdModule.say, {npcHandler = npcHandler, text = 'Do you want to sail ' .. keyword:titleCase() .. ' for ' .. cost ..'?', cost = cost, discount = 'postman'})
...
addTravelKeyword('liberty bay', 110, Position(32349, 32856, 7))
addTravelKeyword('nargor', 110, Position(32024, 32813, 7))
