...
addTravelKeyword('svargrond', 'Svargrond', 230, Position(32253, 31097, 4))
addTravelKeyword('femor hills', 'the Femor Hills', 180, Position(32536, 31837, 4))
addTravelKeyword('edron', 'Edron', 170, Position(33193, 31784, 3))
addTravelKeyword('kazordoon', 'Kazordoon', 150, Position(32588, 31942, 0))
