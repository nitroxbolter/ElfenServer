...
local function addTravelKeyword(keyword, text, cost, destination)
	local travelKeyword = keywordHandler:addKeyword({keyword}, StdModule.say, {npcHandler = npcHandler, text = 'Do you seek a passage to the ' .. text .. ' for ' .. cost .. '?', cost = cost})
...
addTravelKeyword('east', 'east end', 90, Position(32679, 32777, 7))
addTravelKeyword('centre', 'centre', 90, Position(32628, 32771, 7))
