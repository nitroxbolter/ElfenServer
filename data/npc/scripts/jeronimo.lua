...
local items = {
          item1 = {21399, 13030}, -- item1 item que ser� pedido e que ser� dado na primeira troca
          item2 = {21399, 11144}, -- item2 item que ser� pedido e que ser� dado na segunda troca
		  item3 = {21399, 12544}, -- item3 item que ser� pedido e que ser� dado na segunda troca
		  item4 = {21399, 2361}, -- item3 item que ser� pedido e que ser� dado na segunda troca		  
		  item5 = {21399, 10511}, -- item3 item que ser� pedido e que ser� dado na segunda troca
		  item6 = {21399, 10513}, -- item3 item que ser� pedido e que ser� dado na segunda troca
		  item7 = {21399, 10515}, -- item3 item que ser� pedido e que ser� dado na segunda troca
		  item8 = {21399, 2798}, -- item3 item que ser� pedido e que ser� dado na segunda troca
		  item9 = {21399, 20620}, -- item3 item que ser� pedido e que ser� dado na segunda troca		  
		  item10 = {21399, 16105}, -- item3 item que ser� pedido e que ser� dado na segunda troca
		  item11 = {21399, 24809}, -- item3 item que ser� pedido e que ser� dado na segunda troca
		  item12 = {21399, 10455}, -- item3 item que ser� pedido e que ser� dado na segunda troca
		  item13 = {21399, 24777}, -- item3 item que ser� pedido e que ser� dado na segunda troca
		  item14 = {21399, 24317}, -- item3 item que ser� pedido e que ser� dado na segunda troca
		  item15 = {21399, 22396}, -- item3 item que ser� pedido e que ser� dado na segunda troca
		  item16 = {21399, 18411}, -- item3 item que ser� pedido e que ser� dado na segunda troca
		  item17 = {21399, 18409}, -- item3 item que ser� pedido e que ser� dado na segunda troca
		  item18 = {21399, 2400}, -- item3 item que ser� pedido e que ser� dado na segunda troca
		  item19 = {21399, 2431}, -- item3 item que ser� pedido e que ser� dado na segunda troca
		  item20 = {21399, 8928}, -- item3 item que ser� pedido e que ser� dado na segunda troca
		  item21 = {21399, 18453}, -- item3 item que ser� pedido e que ser� dado na segunda troca
		 -- item22 = {21399, 2358}, -- item3 item que ser� pedido e que ser� dado na segunda troca
		  item23 = {21399, 2160} -- item3 item que ser� pedido e que ser� dado na segunda troca
		 
}
local counts = {
          count1 = {15, 1}, -- count1 quantidade que ser� pedido e que ser� dado na primeira troca
          count2 = {10, 1}, -- count2 quantidade que ser� pedido e que ser� dado na segunda troca
		  count3 = {10, 1}, -- count3 quantidade que ser� pedido e que ser� dado na segunda troca
		  count4 = {8, 1}, -- count4 quantidade que ser� pedido e que ser� dado na segunda troca		  
		  count5 = {10, 1}, -- count4 quantidade que ser� pedido e que ser� dado na segunda troca
		  count6 = {10, 1}, -- count4 quantidade que ser� pedido e que ser� dado na segunda troca
		  count7 = {10, 1}, -- count4 quantidade que ser� pedido e que ser� dado na segunda troca
		  count8 = {10, 1}, -- count4 quantidade que ser� pedido e que ser� dado na segunda troca
		  count9 = {10, 1}, -- count4 quantidade que ser� pedido e que ser� dado na segunda troca		  
		  count10 = {10, 1}, -- count4 quantidade que ser� pedido e que ser� dado na segunda troca
		  count11 = {15, 1}, -- count4 quantidade que ser� pedido e que ser� dado na segunda troca
		  count12 = {7, 1}, -- count4 quantidade que ser� pedido e que ser� dado na segunda troca
		  count13 = {15, 1}, -- count4 quantidade que ser� pedido e que ser� dado na segunda troca
		  count14 = {15, 1}, -- count4 quantidade que ser� pedido e que ser� dado na segunda troca
		  count15 = {10, 1}, -- count4 quantidade que ser� pedido e que ser� dado na segunda troca
		  count16 = {5, 1}, -- count4 quantidade que ser� pedido e que ser� dado na segunda troca
		  count17 = {5, 1}, -- count4 quantidade que ser� pedido e que ser� dado na segunda troca
		  count18 = {5, 1}, -- count4 quantidade que ser� pedido e que ser� dado na segunda troca
		  count19 = {5, 1}, -- count4 quantidade que ser� pedido e que ser� dado na segunda troca
		  count20 = {5, 1}, -- count4 quantidade que ser� pedido e que ser� dado na segunda troca
		  count21 = {5, 1}, -- count4 quantidade que ser� pedido e que ser� dado na segunda troca
		--  count22 = {170, 1}, -- count4 quantidade que ser� pedido e que ser� dado na segunda troc
		  count23 = {1, 10} -- count4 quantidade que ser� pedido e que ser� dado na segunda troc
...
function creatureSayCallback(cid, type, msg)
          ...
          if  msgcontains(msg, 'remover skull') then
                    if getPlayerItemCount(cid, items.item2[1]) >= counts.count2[1] then
                              PlayerRemoveItem(cid, items.item2[1], counts.count2[1])
                    ...
                    if getPlayerItemCount(cid, items.item3[1]) >= counts.count3[1] then
                              PlayerRemoveItem(cid, items.item3[1], counts.count3[1])
                    ...
                    if getPlayerItemCount(cid, items.item4[1]) >= counts.count4[1] then
                              PlayerRemoveItem(cid, items.item4[1], counts.count4[1])
                    ...
                    if getPlayerItemCount(cid, items.item5[1]) >= counts.count5[1] then
                              PlayerRemoveItem(cid, items.item5[1], counts.count5[1])
                    ...
                    if getPlayerItemCount(cid, items.item6[1]) >= counts.count6[1] then
                              PlayerRemoveItem(cid, items.item6[1], counts.count6[1])
                    ...
                    if getPlayerItemCount(cid, items.item7[1]) >= counts.count7[1] then
                              PlayerRemoveItem(cid, items.item7[1], counts.count7[1])
                    ...
                    if getPlayerItemCount(cid, items.item8[1]) >= counts.count8[1] then
                              PlayerRemoveItem(cid, items.item8[1], counts.count8[1])
                    ...
                    if getPlayerItemCount(cid, items.item9[1]) >= counts.count9[1] then
                              PlayerRemoveItem(cid, items.item9[1], counts.count9[1])
                    ...
                    if getPlayerItemCount(cid, items.item10[1]) >= counts.count10[1] then
                              PlayerRemoveItem(cid, items.item10[1], counts.count10[1])
                    ...
                    if getPlayerItemCount(cid, items.item11[1]) >= counts.count11[1] then
                              PlayerRemoveItem(cid, items.item11[1], counts.count11[1])
                    ...
                    if getPlayerItemCount(cid, items.item12[1]) >= counts.count12[1] then
                              PlayerRemoveItem(cid, items.item12[1], counts.count12[1])
                    ...
                    if getPlayerItemCount(cid, items.item13[1]) >= counts.count13[1] then
                              PlayerRemoveItem(cid, items.item13[1], counts.count13[1])
                    ...
                    if getPlayerItemCount(cid, items.item14[1]) >= counts.count14[1] then
                              PlayerRemoveItem(cid, items.item14[1], counts.count14[1])
                    ...
                    if getPlayerItemCount(cid, items.item15[1]) >= counts.count15[1] then
                              PlayerRemoveItem(cid, items.item15[1], counts.count15[1])
                    ...
                    if getPlayerItemCount(cid, items.item16[1]) >= counts.count16[1] then
                              PlayerRemoveItem(cid, items.item16[1], counts.count16[1])
                    ...
                    if getPlayerItemCount(cid, items.item17[1]) >= counts.count17[1] then
                              PlayerRemoveItem(cid, items.item17[1], counts.count17[1])
                    ...
                    if getPlayerItemCount(cid, items.item18[1]) >= counts.count18[1] then
                              PlayerRemoveItem(cid, items.item18[1], counts.count18[1])
                    ...
                    if getPlayerItemCount(cid, items.item19[1]) >= counts.count19[1] then
                              PlayerRemoveItem(cid, items.item19[1], counts.count19[1])
                    ...
                    if getPlayerItemCount(cid, items.item20[1]) >= counts.count20[1] then
                              PlayerRemoveItem(cid, items.item20[1], counts.count20[1])
                    ...
                    if getPlayerItemCount(cid, items.item21[1]) >= counts.count21[1] then
                              PlayerRemoveItem(cid, items.item21[1], counts.count21[1])
                    ...
                    if getPlayerItemCount(cid, items.item22[1]) >= counts.count22[1] then
                              PlayerRemoveItem(cid, items.item22[1], counts.count22[1])
                    ...
                    if getPlayerItemCount(cid, items.item23[1]) >= counts.count23[1] then
                              PlayerRemoveItem(cid, items.item23[1], counts.count23[1])
