...
-- Travel
local travelNode = keywordHandler:addKeyword({'svargrond'}, StdModule.say, {npcHandler = npcHandler, text = 'Give me 50 Gold Coins and I bring you to Svargrond. Alright?', cost = 50, discount = 'postman'})
