...
local function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, "mission") then
		...
		if player:getStorageValue(Storage.ChildrenoftheRevolution.Questline) < 1 then
			npcHandler:say({
				"So.., you are offering your help to me? well, i dont know if i can trust you yet ...",
				"You'll have to work to earn my trust. Are you sure you want to offer me your help?"
			}, cid)
			npcHandler.topic[cid] = 1
		elseif player:getStorageValue(Storage.ChildrenoftheRevolution.Questline) == 2 then
			npcHandler:say("What news do you bring here? Did you find any hardened bone? ", cid)
			npcHandler.topic[cid] = 3
		elseif player:getStorageValue(Storage.ChildrenoftheRevolution.Questline) == 3 then
			npcHandler:say({
				"I need this bone called hardened bone for my own use.",
				"Can you get me this bone? "
			}, cid)
