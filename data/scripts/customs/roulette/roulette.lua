...
local config = {
    ...
    roulettePositions = { 
    Position(32539, 32198, 7),
    Position(32540, 32198, 7),
    Position(32541, 32198, 7),
    Position(32542, 32198, 7), 
    Position(32543, 32198, 7),
    Position(32544, 32198, 7),
    Position(32545, 32198, 7),
    Position(32546, 32198, 7),
    Position(32547, 32198, 7),
    Position(32548, 32198, 7),
    Position(32549, 32198, 7),
    Position(32550, 32198, 7),
    Position(32551, 32198, 7),
    Position(32552, 32198, 7),
    }
}
