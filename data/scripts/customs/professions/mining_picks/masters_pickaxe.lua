...
local config = {
    ...
    [26407] = {break_chance = 75, loot_chance = 65, lower_tier = 26423, requiredSkill = 15, 
        normal_loot_table = { -- 80%
    ...
    [26411] = {break_chance = 70, loot_chance = 60, lower_tier = 26420, requiredSkill = 25, 
        normal_loot_table = { -- 80%
    ...
    [26419] = {text = {"Amethyst Vein is regenerating"}}, 
    [26410] = {break_chance = 68, loot_chance = 58, lower_tier = 26419, requiredSkill = 40, 
        normal_loot_table = { -- 80%
            [1] = {item_id = 26400, count = 1}, 
        },
        semi_rare_loot_table = { -- 15%
            [1] = {item_id = 26400, count = 2}, 
        },
        rare_loot_table = { -- 5%
            [1] = {item_id = 26400, count = 4},
        },
    },
    [26421] = {text = {"Ruby Vein is regenerating"}}, 
    [26408] = {break_chance = 66, loot_chance = 56, lower_tier = 26421, requiredSkill = 60, 
        normal_loot_table = { -- 80%
            [1] = {item_id = 26402, count = 1}, 
        },
        semi_rare_loot_table = { -- 15%
            [1] = {item_id = 26402, count = 2}, 
        },
        rare_loot_table = { -- 5%
            [1] = {item_id = 26402, count = 4},
        },
    },
    [26422] = {text = {"Emerald Vein is regenerating"}}, 
    [26409] = {break_chance = 66, loot_chance = 56, lower_tier = 26422, requiredSkill = 80, 
        normal_loot_table = { -- 80%
            [1] = {item_id = 26403, count = 1}, 
        },
        semi_rare_loot_table = { -- 15%
            [1] = {item_id = 26403, count = 2}, 
        },
        rare_loot_table = { -- 5%
            [1] = {item_id = 26403, count = 4},
        },
    },
...
function miningSystem.onUse(cid, item, fromPosition, itemEx, toPosition)
    ...
    local lastUsageTime = player:getStorageValue(215558) 
    ...
    if object then
        if object.text then
            ...
            SendMagicEffect(toPosition, 178)
    ...
    player:setStorageValue(215558, os.time())
    return true
end

miningSystem:id(26417)
