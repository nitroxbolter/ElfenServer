local config = {
    ...
    bossPosition = Position(31877, 31740, 13), 
    bossArea = {
        fromPos = Position(31859, 31721, 13), 
        toPos = Position(31898, 31756, 13), 
        entrancePos = Position(31864, 31740, 13), 
        exitPosition = Position(31879, 31696, 13) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(31873, 31699, 13),
        Position(31873, 31700, 13),
        Position(31873, 31701, 13), 
        Position(31873, 31702, 13), 
    },
    attempts = {
        level = 200, 
        storage = 720020, 
    ...
    createTeleportPos = Position(31880, 31731, 13), 
    teleportToPosition = Position(31876, 31699, 13), 
