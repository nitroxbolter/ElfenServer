...
bool ConditionAttributes::setParam(ConditionParam_t param, int32_t value)
{
	...
	switch (param) {
		...
		case CONDITION_PARAM_SKILL_HERBALIST: {
			skills[SKILL_HERBALIST] = value;
			return true;
		}

		case CONDITION_PARAM_SKILL_HERBALISTPERCENT: {
			skillsPercent[SKILL_HERBALIST] = value;
			return true;
		}

		case CONDITION_PARAM_SKILL_ARMORSMITH: {
			skills[SKILL_ARMORSMITH] = value;
			return true;
		}

		case CONDITION_PARAM_SKILL_ARMORSMITHPERCENT: {
			skillsPercent[SKILL_ARMORSMITH] = value;
			return true;
		}

		case CONDITION_PARAM_SKILL_WEAPONSMITH: {
			skills[SKILL_WEAPONSMITH] = value;
			return true;
		}

		case CONDITION_PARAM_SKILL_WEAPONSMITHPERCENT: {
			skillsPercent[SKILL_WEAPONSMITH] = value;
			return true;
		}

		case CONDITION_PARAM_SKILL_JEWELSMITH: {
			skills[SKILL_JEWELSMITH] = value;
			return true;
		}

		case CONDITION_PARAM_SKILL_JEWELSMITHPERCENT: {
			skillsPercent[SKILL_JEWELSMITH] = value;
			return true;
		}
...
int32_t ConditionAttributes::getParam(ConditionParam_t param)
{
	switch (param) {
		...
		case CONDITION_PARAM_SKILL_HERBALIST:
			return skills[SKILL_HERBALIST];

		case CONDITION_PARAM_SKILL_HERBALISTPERCENT: 
			return skillsPercent[SKILL_HERBALIST];

		case CONDITION_PARAM_SKILL_ARMORSMITH:
			return skills[SKILL_ARMORSMITH];

		case CONDITION_PARAM_SKILL_ARMORSMITHPERCENT: 
			return skillsPercent[SKILL_ARMORSMITH];

		case CONDITION_PARAM_SKILL_WEAPONSMITH:
			return skills[SKILL_WEAPONSMITH];

		case CONDITION_PARAM_SKILL_WEAPONSMITHPERCENT: 
			return skillsPercent[SKILL_WEAPONSMITH];
		
		case CONDITION_PARAM_SKILL_JEWELSMITH:
			return skills[SKILL_JEWELSMITH];

		case CONDITION_PARAM_SKILL_JEWELSMITHPERCENT: 
			return skillsPercent[SKILL_JEWELSMITH];
